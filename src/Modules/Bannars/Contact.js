...
const Banner = ({ HeroBanner }) => {
  ...
  return (
    <>
      <>
        <div
          className="contactjumbotron contactparallax"
          id="contactparallax-static"
        >
              ...
              >
                ...
                >
                  <Grid items xs={12} sm={12} md={12}>
                    <h1 className={classes.HeroBannerTitle}>Contact Us</h1>
                    <Button className={classes.HireNowButton}>submit</Button>
                  </Grid>
                </Grid>
              </Container>
            </div>
