...
const Banner = ({HeroBanner}) => {
    ...
    return (
        <>
        {HeroBanner.map((data)=><>
        {(data.name === 'application-development') ?<div className="mobdevjumbotron mobdevparallax" id="mobdevparallax-static">
           ...
           :(data.name === 'product-development')?<div className="productjumbotron productparallax" id="productparallax-static">
           <div className="showcasebanner">
               <div className="overlaybanner">
                   <Container style={{ padding: '2rem 1rem', marginTop:'15rem'}}  maxWidth='md'>
                       <Grid container style={{ justifyContent: 'center',alignItems:'center' }}>
          ...
          </div>: <div className="devopsjumbotron devopsparallax" id="devopsparallax-static">
           <div className="showcasebanner">
               <div className="overlaybanner">
                   <Container style={{ padding: '2rem 1rem', marginTop:'15rem'}}  maxWidth='md'>
                       <Grid container style={{ justifyContent: 'center',alignItems:'center' }}>
