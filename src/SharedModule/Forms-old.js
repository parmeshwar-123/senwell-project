          ...
          <Grid container>
            <Grid xs={12} sm={12} md={6} className={classes.Image}>
              <div className={classes.img}>
                {showText && <img src={enquiry} alt="img" style={{height:'25rem'}}/>}
              </div>
            </Grid>
            <Grid xs={12} sm={12} md={6}>
              <div>
                <h1 style={{ color: "#3D8ED7" }}>{val.formTitle}</h1>
                <h2>{val.formSubtitle}</h2>
                <div>
                  <TextField
                ...
                <div className={classes.checkbox}>
                  ...
                  />
                  <span>
                    I agree to the Senwell <Link to=""> Cookie Policy</Link> and{" "}
